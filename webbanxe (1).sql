...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 27, 2022 at 07:50 PM
...
CREATE TABLE `admin` (
  ...
  `adm_password` tinytext DEFAULT NULL,
  `adm_phoneNum` tinytext DEFAULT NULL,
  `adm_createdDate` date DEFAULT NULL,
...
ALTER TABLE `bill`
  ...
  ADD KEY `adm_foreignKey` (`bll_managedBy`);
...
--
ALTER TABLE `bill`
  ADD CONSTRAINT `adm_foreignKey` FOREIGN KEY (`bll_managedBy`) REFERENCES `admin` (`adm_id`),
