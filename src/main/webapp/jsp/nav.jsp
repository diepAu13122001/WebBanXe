...
<nav class="navbar">
    <a href="${pageContext.request.contextPath}"> <img src="https://www.linkpicture.com/q/dark-logo.png"
                                                       class="brand-logo" alt=""></a>
    <ul class="links-container">
        <li class="link-item"><a href="${pageContext.request.contextPath}/Products" class="link">Sản phẩm</a></li>
        <li class="link-item"><a href="${pageContext.request.contextPath}/Insurances" class="link">Chính sách bảo
            hành</a></li>
